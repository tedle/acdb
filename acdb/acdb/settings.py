"""
Django settings for acdb project.
...
# Store SECRET_KEY in secret_key.py, if doesnt exist then generate
try:
...
ROOT_URLCONF = 'acdb.urls'

WSGI_APPLICATION = 'acdb.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'accf.db'),
    }
}
